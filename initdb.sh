...
docker-compose exec django pipenv run django-admin.py migrate --database=mercenaries
...
docker-compose exec django pipenv run django-admin.py load_mercenaries_cards
